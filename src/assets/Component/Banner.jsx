  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center pt-6 gap-4">
        <div className="bg-[#b9f7ce] border border-[#b9f7ce] rounded-xl w-95.75 h-172 flex flex-col pl-4 gap-4 pt-4 justify-start items-start">
          ...
          <div className="bg-[#1d2a3d] flex justify-center items-center text-white rounded-xl font-medium w-36 h-10">
            <button>Learn More</button>
          </div>
          <div>
            <img
              className="absolute w-95.5 h-101 top-99 left-10"
              src="./public/hero_model.png"
              alt=""
            />
          </div>
        </div>
        <div className="bg-[#ffd6a8] flex  justify-around items-center gap-4 w-95.75 h-48 rounded-2xl">
        ...
        <div className="bg-[#bedaff] flex  justify-around items-center gap-4 w-95.75 h-48 rounded-2xl">
          <div className="w-40 h-18 flex flex-col gap-4">
            <h2 className="text-4xl bg-liner-to-r from-[#272937] w-40 h-18 to-[#b18254] bg-clip-text ">
             20% Discounts
            </h2>
