  ...
  return (
    <>
      <div className="flex flex-col gap-3  overflow-x-hidden">
        <div className="flex flex-col gap-4 relative  pt-6 pl-4 pr-4 pb-4 justify-between sm:pb-16 sm:flex-row sm:justify-between sm:items-center sm:pl-20">
          <div className="sm:gap-3 sm:flex sm:flex-col">
            <div className="flex flex-col gap-4">
              ...
              <div>
                <p className="text-[#938f9c] w-96 h-20  ">
          ...
          <div>
            <div className="grid grid-cols-2 gap-3  items-center sm:flex sm:flex-row sm:gap-16 sm:pr-16 sm:justify-between sm:items-center">
              ...
              <div className="flex flex-col gap-3 sm:flex sm:flex-col sm:mt-0 ">
              ...
              <div className="flex flex-col gap-3 sm:mb-8">
                <h2 className="text-[#524e74] font-medium">CONTACT</h2>
                <ul className="text-[#7c7f97] flex flex-col gap-2 font-medium ">
                  <li>
                    <div className="flex gap-2 items-center sm:text-xs sm:gap-3 sm:flex sm:flex-row">
                      <i>
                        <FaRegEnvelope />
                      </i>
                      <p>+1-212-456-7890</p>
        ...
        <div>
          <div className="sm:flex sm:pl-18">
            <div className="border-b-2  border-gray-300 sm:border-r sm:border-gray-300 sm:items-center sm:w-350 sm:flex sm:justify-center  "></div>
          </div>
          <div className="pl-2 pb-6 justify-start flex items-center">
            <p className="text-[#7c7f97] sm:pl-18 sm:pt-4">
